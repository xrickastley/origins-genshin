...
public final class FrozenCrystallizeElementalReaction extends AbstractCrystallizeElementalReaction {
	FrozenCrystallizeElementalReaction() {
		super(
			new ElementalReactionSettings("Crystallize", OriginsGenshin.identifier("crystallize_frozen"), TextHelper.reaction("reaction.origins-genshin.crystallize", "#f79c00"))
