...
public final class ElectroCrystallizeElementalReaction extends AbstractCrystallizeElementalReaction {
	ElectroCrystallizeElementalReaction() {
		super(
			new ElementalReactionSettings("Crystallize", OriginsGenshin.identifier("crystallize_electro"), TextHelper.reaction("reaction.origins-genshin.crystallize", "#f79c00"))
